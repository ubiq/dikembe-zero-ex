...
// InternalBuyERC721 is a paid mutator transaction binding the contract method 0x60018b41.
//
...
func (_ERC721OrdersFeature *ERC721OrdersFeatureTransactor) InternalBuyERC721(opts *bind.TransactOpts, sellOrder LibNFTOrderERC721Order, signature LibSignatureSignature, ethAvailable *big.Int, takerCallbackData []byte) (*types.Transaction, error) {
...
//
// Solidity: function _buyERC721((uint8,address,address,uint256,uint256,address,uint256,(address,uint256,bytes)[],address,uint256,(address,bytes)[]) sellOrder, (uint8,uint8,bytes32,bytes32) signature, uint256 ethAvailable, bytes takerCallbackData) payable returns()
func (_ERC721OrdersFeature *ERC721OrdersFeatureSession) InternalBuyERC721(sellOrder LibNFTOrderERC721Order, signature LibSignatureSignature, ethAvailable *big.Int, takerCallbackData []byte) (*types.Transaction, error) {
	return _ERC721OrdersFeature.Contract.InternalBuyERC721(&_ERC721OrdersFeature.TransactOpts, sellOrder, signature, ethAvailable, takerCallbackData)
}

// InternalBuyERC721 is a paid mutator transaction binding the contract method 0x60018b41.
//
// Solidity: function _buyERC721((uint8,address,address,uint256,uint256,address,uint256,(address,uint256,bytes)[],address,uint256,(address,bytes)[]) sellOrder, (uint8,uint8,bytes32,bytes32) signature, uint256 ethAvailable, bytes takerCallbackData) payable returns()
func (_ERC721OrdersFeature *ERC721OrdersFeatureTransactorSession) InternalBuyERC721(sellOrder LibNFTOrderERC721Order, signature LibSignatureSignature, ethAvailable *big.Int, takerCallbackData []byte) (*types.Transaction, error) {
	return _ERC721OrdersFeature.Contract.InternalBuyERC721(&_ERC721OrdersFeature.TransactOpts, sellOrder, signature, ethAvailable, takerCallbackData)
}
...
// BuyERC721 is a paid mutator transaction binding the contract method 0xfbee349d.
//
...
func (_ERC721OrdersFeature *ERC721OrdersFeatureTransactor) BuyERC721(opts *bind.TransactOpts, sellOrder LibNFTOrderERC721Order, signature LibSignatureSignature, callbackData []byte) (*types.Transaction, error) {
...
//
// Solidity: function buyERC721((uint8,address,address,uint256,uint256,address,uint256,(address,uint256,bytes)[],address,uint256,(address,bytes)[]) sellOrder, (uint8,uint8,bytes32,bytes32) signature, bytes callbackData) payable returns()
func (_ERC721OrdersFeature *ERC721OrdersFeatureSession) BuyERC721(sellOrder LibNFTOrderERC721Order, signature LibSignatureSignature, callbackData []byte) (*types.Transaction, error) {
	return _ERC721OrdersFeature.Contract.BuyERC721(&_ERC721OrdersFeature.TransactOpts, sellOrder, signature, callbackData)
}

// BuyERC721 is a paid mutator transaction binding the contract method 0xfbee349d.
//
// Solidity: function buyERC721((uint8,address,address,uint256,uint256,address,uint256,(address,uint256,bytes)[],address,uint256,(address,bytes)[]) sellOrder, (uint8,uint8,bytes32,bytes32) signature, bytes callbackData) payable returns()
func (_ERC721OrdersFeature *ERC721OrdersFeatureTransactorSession) BuyERC721(sellOrder LibNFTOrderERC721Order, signature LibSignatureSignature, callbackData []byte) (*types.Transaction, error) {
	return _ERC721OrdersFeature.Contract.BuyERC721(&_ERC721OrdersFeature.TransactOpts, sellOrder, signature, callbackData)
}
